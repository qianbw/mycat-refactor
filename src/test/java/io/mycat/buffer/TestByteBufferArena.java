...
public class TestByteBufferArena {
	...
	// int allocTimes = 1024 ;
	// ByteBufferArena byteBufferArena = new
	// ByteBufferArena(chunkSize,pageSize,chunkCount,8);
	...
	// System.out.println("ByteBufferArena total used time  " + used +
	// " avg speed " + allocTimes / used);
	// }
